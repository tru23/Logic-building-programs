...
using namespace std;
template <class T>
class ArrayX        //binary search decending order
{
public:
    T *arr;
    int iSize;
    ...
    template<class T>
     void ArrayX <T>::BubbleSort()
     {
        ...
        int i=0,j=0;
        //   1      2    3
        for(i=0;i<iSize-1;i++) //outer -1 karan 1 da ugach run hotoi jevha pahilya element var yeto
        {  //    1     2      3
            for(j=0;j<iSize-1-i;j++)// -i lihila karan fhaltu phiraila lagta nhi sort zhalaya var
            {
