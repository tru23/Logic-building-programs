...
void man(char *name)
{
    ...
    {
        printf("Description:Used to read data into regular files\n");
    ...
    {
        printf("Description:Used to display information files\n");
...
/*
C:\Users\trupt\OneDrive\Desktop\logic building programs>g++ program502.cpp -o program502.exe

C:\Users\trupt\OneDrive\Desktop\logic building programs>program502.exe
...
Virtual File System : > man create
Description:used to create new regular file
Usage:create File_name Permission

Virtual File System : > create Demo.txt

ERROR : Command not found !!!

Virtual File System : > create Demo.txt 3
File is successfully created with file descriptor : 0

Virtual File System : > create Hello.txt 3
...
Description:Used to write into regular files
Usage:read File_name
 After this enter the data that we want to write

Virtual File System : > write Demo.txt
Enter the data :
jay ganesh...
...
Virtual File System : > stat Demo.txt
...
Virtual File System : > read Demo.txt 6
jay ga
Virtual File System : > read Demo.txt 2
ne
Virtual File System : > stat Demo.txt
...
Description:Used to remove data from files
Usage:truncate File_name

Virtual File System : > truncate Demo.txt
...
Description:Used to delete the files
Usage:rm File_name

Virtual File System : > rm Demo.txt
...
C:\Users\trupt\OneDrive\Desktop\logic building programs>*/