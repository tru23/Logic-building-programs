...
int main()
{
    ...
    obj.InsertFirst(51.76f);
    obj.InsertFirst(21.78f);
    obj.InsertFirst(11.56f);

    obj.Display();
    iRet=obj.Count();
    cout<<"Number of elements are: "<<iRet<<endl;

    obj.InsertLast(103.56f);
    obj.InsertLast(112.90f);
    obj.InsertLast(105.45f);
